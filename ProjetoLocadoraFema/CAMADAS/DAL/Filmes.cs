...
namespace ProjetoLocadoraFema.CAMADAS.DAL
{
    public class Filmes
    {
        ...
        {
            SqlConnection conexao = new SqlConnection(strCon);
            string sql = "INSERT INTO Filmes VALUES (@ID_Filme, @Produtora_Filme, @Nome_Filme, @Categoria_Filme, @Data_Filme, @Classificacao_Filme, @Preco_Filme);";
            SqlCommand cmd = new SqlCommand(sql, conexao);
        ...
        public void Update(MODEL.Filmes filmes)
        {
            ...
            SqlConnection conexao = new SqlConnection(strCon);
            string sql = "UPDATE Filmes SET Produtora=@Produtora, Nome=@Nome, Categoria=@Categoria, Data=@Data, Faixa=@Faixa, Valor=@Valor";
            sql += " WHERE ID=@ID;";
            SqlCommand cmd = new SqlCommand(sql, conexao);
        ...
        public List<MODEL.Filmes> SelectByID(int filmes)
        {
            List<MODEL.Filmes> lstFilmes = new List<MODEL.Filmes>();
            SqlConnection conexao = new SqlConnection(strCon);
        ...
        public List<MODEL.Filmes> SelectByNome(String Nome)
        {
            List<MODEL.Filmes> lstFilmes = new List<MODEL.Filmes>();
            SqlConnection conexao = new SqlConnection(strCon);
